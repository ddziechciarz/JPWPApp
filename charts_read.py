...
def charts_month_last_img():
    ...
    plt.xlabel('Dzień')
    plt.ylabel('Wartość')
    plt.title('Miesieczna produkcja')
    plt.yticks([10, 20, 30, 40], ['10kWh', '20kWh', '30kWh', '40kWh'])
    plt.grid(axis='y')
    plt.savefig('img/charts_month_last.jpg', format='jpg')
    plt.close()


def charts_month_today_img():
    time = []
    value = []
    ...
    plt.yticks([10, 20, 30, 40], ['10kWh', '20kWh', '30kWh', '40kWh'])
    plt.grid(axis='y')
    plt.savefig('img/charts_month_today.jpg', format='jpg')
    plt.close()
chart_today_img()
charts_month_last_img()
charts_month_today_img()